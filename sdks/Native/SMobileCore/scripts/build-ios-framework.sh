...
# Defaults: keep current scheme, output as SMobileCore to host multiple native packages later.
FRAMEWORK_NAME="${FRAMEWORK_NAME:-SMobileCore}"
SCHEME_NAME="${SCHEME_NAME:-SMobileCore}"

FINXCORE_XCFRAMEWORK_DIR="$REPO_ROOT/sdks/ReactNative/SMobileCoreRN/native-sdk/ios/${FRAMEWORK_NAME}.xcframework"
