...
public enum FinXCryptoError: Error {
  case invalidKey
  case invalidNonce
...
public enum FinXCrypto {
  ...
  public static func randomBytes(count: Int) throws -> Data {
    ...
    guard status == errSecSuccess else {
      throw FinXCryptoError.randomGenerationFailed(status)
    }
    return data
  }
  ...
  public static func aesGCMEncrypt(
    ...
    guard key.count >= 16 else { throw FinXCryptoError.invalidKey }
